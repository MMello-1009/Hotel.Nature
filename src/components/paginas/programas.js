...
function Programas() {
  return (
    <div className="programas">
      ...
      <p className="subtitulos">Guiado:</p>
      <p className="texto">Sim</p>
      <p className="subtitulos">Duração:</p>
      <p className="texto">3h</p>
      <p className="subtitulos">Disponível:</p>
      <p className="texto">Maio a Setembro</p>
      <p className="subtitulos">NºPessoas:</p>
      <p className="texto">Mínimo 1 pessoa</p>
      <p className="subtitulos">Nível:</p>
      <p className="texto">Fácil</p>
      <p className="subtitulos">Idade Mínima:</p>
      <p className="texto">12 anos</p>
      <p className="subtitulos">Preço:</p>
      <p className="texto">50€ por pessoa</p>
      <p className="subtitulos">Material incluído:</p>
      <p className="texto">Fato e botas</p>
      ...
      <p className="texto">Sim</p>
      <p className="subtitulos">Duração:</p>
      <p className="texto">5h</p>
      <p className="subtitulos">Idade:</p>
      <p className="texto"> Sem restrições de idade, porém recomenda-se que que traga cadeira de criança caso seja necessário</p>
      <p className="subtitulos">Disponível:</p>
      <p className="texto">Todo o ano</p>
      <p className="subtitulos">NºPessoas:</p>
      <p className="texto">Mínimo 2 Pessoas</p>
      <p className="subtitulos">Preço:</p>
      <p className="texto">20€ por Pessoa</p>
      <p className="subtitulos">Reservas através de:</p>
      <p className="texto">hotel@real.natura.pt ou Tlf: +351 253 682 396</p>
      ...
      <img className="segunda-imagem" src="../Imagens/Programas/Cavalo2.jpg"></img>
      <img className="primeira-imagem" src="../Imagens/Programas/Cavalo.jpg"></img>
      <br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br><br></br>
      <h3 className="sobre-atividade">Sobre esta atividade:</h3>
      <p className="subtitulos">Descrição:</p>
      ...
      <p className="subtitulos">Duração:</p>
      <p className="texto">1h</p>
      <p className="subtitulos">Idade mínima:</p>
      <p className="texto">15 anos</p>
      <p className="subtitulos">Preço:</p>
      <p className="texto">30€ por Pessoa</p>
      <p className="subtitulos">Reservas através de:</p>
      <p className="texto">hotel@real.natura.pt ou Tlf: +351 253 682 396</p>
